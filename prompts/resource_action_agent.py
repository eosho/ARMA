...
- Use list_resource_groups_tool for 'list_resource_groups' intent (listing all resource groups in a subscription).
...
- For 'list_resource_groups', you must have: subscription_id.
...
State: {"intent": "list_resource_groups", "subscription_id": "..."}
Action: Use list_resource_groups_tool.
